<template>
  <div>
    <div class="members-container bg">
      <div class="container-xl">
        <h2 class="members-title">Idealizadores Aus Ouvidos</h2>
        <div class="members-list">
          <div class="member-item" v-for="teamMember in idealizadores" :key="teamMember.id">
            ...
            <div class="member-social">
              ...
              <a v-if="teamMember.linkedIn" :href="teamMember.linkedIn" class="icon icon-linkedin" title="LinkedIn" target="_blank">
    ...
    <div class="members-container">
      <div class="container-xl">
        <h2 class="members-title">Equipe Aus Ouvidos</h2>
        <div class="members-list">
...
<script lang="ts" src="./equipe.ts"></script>
